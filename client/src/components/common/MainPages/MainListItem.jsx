...
function MainListItem({ title, subtitle, mcqs }) {
  return (
    <>
      <div
        href="#"
      ...
      >
       ...
       <Button
          variant="green"
          buttonStyle="m-0 bg-green-500 text-xs md:text-sm font-bold py-1 md:py-2  px-3"
        >
          View Details
        </Button>
        <Button
          variant="primary"
          buttonStyle="m-0 bg-blue-500 text-xs md:text-sm font-bold py-1 md:py-2  px-3"
        >
          Apply Now
        </Button>
        <Button
          variant="danger"
          buttonStyle="m-0 bg-red-700 text-xs md:text-sm font-bold md:py-2  px-6"
        >
          Delete
        </Button>
       </div>   
